    ...
    return (
        <>
            <div className="flex flex-col gap-8 z-10">
                <div className="w-[775px] max-[820px]:max-w-[600px] max-[648px]:max-w-[480px] max-[524px]:max-w-[460px] max-[492px]:max-w-[400px] max-[440px]:max-w-[354px] max-[360px]:max-w-[296px] border-[1px] rounded-2xl relative z-10">
