...
export const Modal: React.FC<ModalProps> = ({
    ...
    return (
        <>
            <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-[222222222222] outline-none focus:outline-none  bg-neutral-800/10">
